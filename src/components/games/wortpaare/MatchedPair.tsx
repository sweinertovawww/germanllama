  ...
  return (
    <div className="flex items-center gap-2 sm:gap-3 rounded-xl border-2 border-border/60 bg-muted/50 px-3 py-2.5 sm:px-4 sm:py-3 opacity-90">
      ...
      <div className="flex-1 text-center">
        ...
        <p className="font-body text-xs text-muted-foreground">{lang === "ko" ? (pair.translation_a_ko || pair.translation_a) : lang === "pl" ? (pair.translation_a_pl || pair.translation_a) : pair.translation_a}</p>
      </div>
      ...
      <div className="flex-1 text-center">
        ...
        <p className="font-body text-xs text-muted-foreground">{lang === "ko" ? (pair.translation_b_ko || pair.translation_b) : lang === "pl" ? (pair.translation_b_pl || pair.translation_b) : pair.translation_b}</p>
      </div>
